...
*Modified by : The Robot Studio - Cyril Jourdan
*/
...
/*** Variables ***/
string filename = ros::package::getPath("trs_vision") + "/resources/haarcascade_frontalface_alt.xml";
static const char *faceCascadeFilename = filename.c_str(); // Haar Cascade file, used for Face Detection.
