...
//#define PKG_NAME trs_vision
#include <ros/package.h>

using namespace std;
static const char *faceCascadeFilename = "/home/dcx/catkin_hydro_ws/src/trs_vision/resources/haarcascade_frontalface_alt.xml";
//ros::package::getPath("trs_vision").c_str() + "/resources/haarcascade_frontalface_alt.xml";   // Haar Cascade file, used for Face Detection.
...
{
	const CvSize minFeatureSize = cvSize(5, 5);
	const int flags = CV_HAAR_DO_CANNY_PRUNING; //CV_HAAR_FIND_BIGGEST_OBJECT | CV_HAAR_DO_ROUGH_SEARCH;	// Only search for 1 face.
